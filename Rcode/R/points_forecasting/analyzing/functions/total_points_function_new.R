...
total_points_chips_player <- function(round,final_team,captain,vice_captain,triple_captain,penalty,points_round,minutes_round){
  ...
  points_players <- points_players %>% select(index,points)
