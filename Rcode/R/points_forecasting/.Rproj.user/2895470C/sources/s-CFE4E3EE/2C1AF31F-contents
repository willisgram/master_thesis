...
upper_lim <- 38 #38-2*k+2 #+1 due to index, does not consider round 38
...
team_round_k_16$team <- if_else(
  team_round_k_16$team == "HUL",true = "HUD",false = team_round_k_16$team)
team_round_k_16$team <- if_else(
  team_round_k_16$team == "MID",true = "BHA",false = team_round_k_16$team) 
team_round_k_16$team <- if_else(
  team_round_k_16$team == "SUN",true = "NEW",false = team_round_k_16$team) 
...
h_a_16_reg <- h_a_16
h_a_16_reg[h_a_16_reg == "W"] <- NA
index <- data.frame(index = 1:625)
h_a_16_reg <- cbind(index,h_a_16_reg)

for (i in seq(from = 6,by = 1, to = upper_lim)) {
  
  h_a_16_reg_round_temp <- data.frame(index = 1:625)
  h_a_16_reg_round_temp[,2] <- h_a_16_reg[,((i+k-1))]
  
  colnames(h_a_16_reg_round_temp)[2] <- "H_A"
  
  if(i == 6){
    h_a_16_reg_round_k_16 <- h_a_16_reg_round_temp
  } else{
    h_a_16_reg_round_k_16    <- rbind(h_a_16_reg_round_k_16,h_a_16_reg_round_temp)  
  }
  
}

h_a_16_reg_round_k_16 <- h_a_16_reg_round_k_16 %>% select(H_A)
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  last_season_tot_p_round_temp[,2] <- last_season_tot_p_round_16[,i-6+k]
  
  colnames(last_season_tot_p_round_temp)[2] <- "last_season_tot_p" 
  
  if(i == 6){
    last_season_tot_p_round_k_16 <- last_season_tot_p_round_temp
  } else{
    last_season_tot_p_round_k_16    <- rbind(last_season_tot_p_round_k_16,last_season_tot_p_round_temp)  
  }
  
}

last_season_tot_p_round_k_16 <- last_season_tot_p_round_k_16 %>% select(last_season_tot_p)
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  minutes_round_temp[,2] <- minutes_round_16[,i-6+k]
  
  colnames(minutes_round_temp)[2] <- "minutes" 
  
  if(i == 6){
    minutes_round_k_16 <- minutes_round_temp
  } else{
    minutes_round_k_16    <- rbind(minutes_round_k_16,minutes_round_temp)  
  }
  
}

minutes_round_k_16 <- minutes_round_k_16 %>% select(minutes)
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  tot_points_round_temp[,2] <- tot_points_round_16[,i-6+k]
  
  colnames(tot_points_round_temp)[2] <- "tot_points" 
  
  if(i == 6){
    tot_points_round_k_16 <- tot_points_round_temp
  } else{
    tot_points_round_k_16    <- rbind(tot_points_round_k_16,tot_points_round_temp)  
  }
  
}

tot_points_round_k_16 <- tot_points_round_k_16 %>% select(tot_points)

#Yellow cards
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  
  y_cards_round_temp <- data.frame(index = 1:625)
  y_cards_round_temp[,2] <- y_cards_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  goals_con_round_temp[,2] <- goals_con_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  saves_round_temp[,2] <- saves_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  goals_round_temp[,2] <- goals_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  pen_miss_round_temp[,2] <- pen_miss_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  pen_save_round_temp[,2] <- pen_save_round_16[,i-6+k]
  
  colnames(pen_save_round_temp)[2] <- "pen_save" 
  
  if(i == 6){
    pen_save_round_k_16 <- pen_save_round_temp
  } else{
    pen_save_round_k_16    <- rbind(pen_save_round_k_16,pen_save_round_temp)  
  }
  
}

pen_save_round_k_16 <- pen_save_round_k_16 %>% select(pen_save)

#Clean sheets
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  
  clean_sheet_round_temp <- data.frame(index = 1:625)
  clean_sheet_round_temp[,2] <- clean_sheet_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  assists_round_temp[,2] <- assists_round_16[,i-6+k]
  
  colnames(assists_round_temp)[2] <- "assists" 
  
  if(i == 6){
    assists_round_k_16 <- assists_round_temp
  } else{
    assists_round_k_16    <- rbind(assists_round_k_16,assists_round_temp)  
  }
  
}

assists_round_k_16 <- assists_round_k_16 %>% select(assists)

#Own Goals
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  
  own_goals_round_temp <- data.frame(index = 1:625)
  own_goals_round_temp[,2] <- own_goals_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  dream_team_round_temp[,2] <- dream_team_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  r_cards_round_temp[,2] <- r_cards_round_16[,i-6+k]
...
for (i in seq(from = 6,by = 1, to = upper_lim)) {
  ...
  BPS_round_temp[,2] <- BPS_round_16[,i-6+k]
...
regressors_16 <- cbind(points_round_k_16,opponent_round_k_16,team_round_k_16,cost_round_k_16,
                       pos_round_k_16,trans_in_round_k_16,trans_out_round_k_16,last_season_tot_p_round_k_16,h_a_16_reg_round_k_16,minutes_round_k_16,
                       tot_points_round_k_16, y_cards_round_k_16, goals_con_round_k_16, saves_round_k_16, goals_round_k_16, pen_miss_round_k_16,
                       pen_save_round_k_16, clean_sheet_round_k_16,assists_round_k_16, own_goals_round_k_16, dream_team_round_k_16,
                       r_cards_round_k_16, BPS_round_k_16)
