...
#2 <- week_for%%k+4
k<-4 #not consider time series aspect of points
upper_lim <- 36 #38-2*k+2 #+1 due to index, does not consider round 38
...
regressors_16 <- cbind(points_round_k_16,opponent_round_k_16,team_round_k_16,cost_round_k_16,
                       pos_round_k_16,trans_in_round_k_16,trans_out_round_k_16,last_season_tot_p_round_k_16,tot_points_round_k_16,
                       y_cards_round_k_16, goals_con_round_k_16, saves_round_k_16, goals_round_k_16, pen_miss_round_k_16,
