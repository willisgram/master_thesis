...
elo_team_16 <- elo_team
elo_opponent_16 <- elo_opponent

write.csv(x = elo_team_16,file = "load/data_16/data_16_output/elo_team_16.csv")
write.csv(x = elo_opponent_16,file = "load/data_16/data_16_output/elo_opponent_16.csv")
...
streak_matrix_16 <- streak_matrix[1:38]

write.csv(x = streak_matrix_16,"load/data_16/data_16_output/streak_matrix_16.csv")
